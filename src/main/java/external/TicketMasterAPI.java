...
public class TicketMasterAPI {
	...
	private static final String API_KEY = "eEwkCbqZ896lz96C9ffBky1QTOY9hy9y";
	...
	public List<Item> search(double lat, double lon, String keyword) {
		// encode keyword in the url since it may contain special characters
		if (keyword == null) {
